...
function ProductPage({ searchTerm }) {
    ...
    function handlePrintProduct(data, searchTerm) {
    ...
    return (
        <div>
            ...
            <div className="container d-flex flex-wrap justify-content-sm-start justify-content-center g-2">
                {data ? (handlePrintProduct(data, searchTerm)?.every((element) => element === undefined) ? <NotFound /> : handlePrintProduct(data, searchTerm)) : <Loader />}
            </div>
        </div>
    );
}
